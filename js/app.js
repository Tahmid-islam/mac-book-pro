...
function updateTotal() {
  let memory = parseInt(getId("memory-price").innerText);
  let storage = parseInt(getId("storage-price").innerText);
  let delivery = parseInt(getId("delivery-price").innerText);
